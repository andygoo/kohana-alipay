...
class Kohana_AlipaySubmit 
{
	...
	function buildRequestParaToString($para_temp) 
	{
		...
		$request_data = Func_AlipayCore::createLinkstringUrlencode($para);
	...
	function buildRequestHttp($para_temp) 
	{
		...
		//远程获取数据
		$sResult = Func_AlipayCore::getHttpResponsePOST($this->alipay_gateway_new, $this->alipay_config['cacert'],$request_data,trim(strtolower($this->alipay_config['input_charset'])));
	...
	function buildRequestHttpInFile($para_temp, $file_para_name, $file_name) 
	{
		...
		//远程获取数据
		$sResult = Func_AlipayCore::getHttpResponsePOST($this->alipay_gateway_new, $this->alipay_config['cacert'],$para,trim(strtolower($this->alipay_config['input_charset'])));
